...
%     disp(num2str(norm(y_N, 2)));
    ...
    for i_1 = 1:C1L
        ...
        [x_ASVD1, ~] = ASVD1_Fails(U_N, S_N, V_N, y_N, C);
    ...
    for i_2 = 1:C2L
        ...
        [x_ASVD2, ~] = ASVD2_Fails(U_N, S_N, V_N, y_N, C);
...
% saveas(figure(1), strcat(name, '_IG_FNA1_ASVD1_Fails_err'), 'epsc');
% saveas(figure(1), strcat(name, '_IG_FNA1_ASVD1_Fails_err.fig'));
%% ASVD2_Err plot
...
% saveas(figure(2), strcat(name, '_IG_FNA1_ASVD2_Fails_err'), 'epsc');
% saveas(figure(2), strcat(name, '_IG_FNA1_ASVD2_Fails_err.fig'));
%% ASVD1_Coef plot
...
% saveas(figure(3), strcat(name, '_IG_FNA1_ASVD1_Fails_coef'), 'epsc');
% saveas(figure(3), strcat(name, '_IG_FNA1_ASVD1_Fails_coef.fig'));
%% ASVD2_Coef plot
...
hold off
% 
% saveas(figure(4), strcat(name, '_IG_FNA1_ASVD2_Fails_coef'), 'epsc');
% saveas(figure(4), strcat(name, '_IG_FNA1_ASVD2_Fails_coef.fig'));
