...
C1Vect = [.2, .4, .6, .8, 1.1]';   C2Vect = [.4, .8, 1.2 ,1.6, 2.1]';
...
% saveas(figure(1), strcat(name, '_IG_FNA1_ASVD1_C_err'), 'epsc');
% saveas(figure(1), strcat(name, '_IG_FNA1_ASVD1_C_err.fig'));
%% ASVD2_Err plot
...
% saveas(figure(2), strcat(name, '_IG_FNA1_ASVD2_C_err'), 'epsc');
% saveas(figure(2), strcat(name, '_IG_FNA1_ASVD2_C_err.fig'));
%% ASVD1_Coef plot
...
% saveas(figure(3), strcat(name, '_IG_FNA1_ASVD1_C_coef'), 'epsc');
% saveas(figure(3), strcat(name, '_IG_FNA1_ASVD1_C_coef.fig'));
%% ASVD2_Coef plot
...
% saveas(figure(4), strcat(name, '_IG_FNA1_ASVD2_C_coef'), 'epsc');
% saveas(figure(4), strcat(name, '_IG_FNA1_ASVD2_C_coef.fig'));
